        ...
        <div className="px-10 py-10 w-full lg:max-w-[1200px] mx-auto">
          <div className="flex gap-16 items-center justify-center">
            ...
            <div>
              ...
              <p>At Paw Match, we dream of a world where the echoes of happy barks and content purrs fill every home. Our vision is to be the heartbeat of pet adoption, fostering connections that bring joy, companionship, and a forever home to every creature with Paw Match.</p>
            </div>
          </div>
          {/*  */}
          ...
          <div className="flex gap-16 items-center justify-center">
            ...
            <div>
              ...
              <p>Paw Match values the diversity in every wag, meow, and chirp, recognizing the unique charm each pet brings. Our core values revolve around inclusivity, compassion, and the belief that every pet, regardless of their past, deserves a warm, loving embrace. We are dedicated to upholding the principles of responsible pet ownership, ensuring that the Paw Match community is a sanctuary of unconditional love and lifelong connections...</p>
            </div>
          </div>
        </div>
            <div>
