...
const AllUsersDeshboard = () => {
  ...
  {/* Sidebar */}
  <aside className="hidden lg:flex col-span-1 bg-[#D52B5C] text-white flex-col items-start py-8 px-4 shadow-lg">
  ...
  <main className="col-span-4 lg:col-span-3 bg-pink-50 relative">
    ...
    <div className="lg:hidden flex justify-end p-4">
      <div className="dropdown relative">
        ...
        <ul className="menu dropdown-content mt-3 z-10 p-2 shadow-lg bg-white rounded-box w-56 text-gray-700">
          {navLinks}
        </ul>
      </div>
    </div>
    ...
    {/* Dashboard Header */}
    <section className="bg-warning py-10 rounded-b-3xl shadow-inner">
      <p className="text-4xl font-bold text-center border-y-4 w-4/5 md:w-2/5 mx-auto py-2 text-[#3f3f3f]">
        Admin Dashboard
      </p>
    </section>
