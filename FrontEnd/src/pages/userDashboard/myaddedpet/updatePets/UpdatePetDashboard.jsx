...
<div className="grid grid-cols-1 lg:grid-cols-4">
  {/* Sidebar */}
  <div className="min-h-screen bg-gradient-to-t from-pink-400 to-red-500 col-span-1 hidden lg:flex flex-col justify-between p-6">
  ...
  <div className="min-h-screen bg-pink-50 lg:col-span-3 col-span-4">
    ...
    {/* Header */}
    <div className="h-40 bg-gradient-to-r from-pink-400 to-red-500 py-10 text-center">
      <p className="text-4xl font-bold text-white border-y-2 w-4/12 mx-auto">User Dashboard</p>
    </div>
